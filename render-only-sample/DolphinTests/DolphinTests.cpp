...
PVOID MyLoadResource(INT Name, DWORD *pdwSize)
{
...
HRESULT MyCreateShaderResourceViewFromBuffer(PVOID pBuffer, UINT Width, UINT Height, DXGI_FORMAT Format, ID3D11ShaderResourceView **ppSRView, ID3D11Device* pDevice)
{
    HRESULT                         hr = S_OK;
