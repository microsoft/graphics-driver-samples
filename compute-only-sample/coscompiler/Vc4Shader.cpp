    ...
    { 
        ...
        case D3D10_SB_OPCODE_DCL_INPUT_PS:
            ...
            for (uint8_t i = 0, aCurrent = D3D10_SB_OPERAND_4_COMPONENT_MASK_X; i < 4; i++)
            {
                if (Inst.m_Operands[0].m_WriteMask & aCurrent)
                {
                    VC4_ASSERT((COS_VC4_INPUT_REGISTER_FILE_START + cInput) <= COS_VC4_INPUT_REGISTER_FILE_END);
                    ...
                    this->InputRegister[Inst.m_Operands[0].m_Index[0].m_RegIndex][i].addr = COS_VC4_INPUT_REGISTER_FILE_START + cInput++;
                    this->InputRegister[Inst.m_Operands[0].m_Index[0].m_RegIndex][i].mux = COS_VC4_INPUT_REGISTER_FILE;
        ...
        case D3D10_SB_OPCODE_DCL_OUTPUT_SIV:
            ...
            if (this->uShaderType == D3D10_SB_PIXEL_SHADER)
            {
                ...
                this->OutputRegister[0][0].addr = COS_VC4_OUTPUT_REGISTER_FILE_START;
                this->OutputRegister[0][0].mux = COS_VC4_OUTPUT_REGISTER_FILE;
            ...
            else
            {
                ...
                for (uint8_t i = 0, aCurrent = D3D10_SB_OPERAND_4_COMPONENT_MASK_X; i < 4; i++)
                {
                    if (aMask & aCurrent)
                    {
                        VC4_ASSERT((COS_VC4_OUTPUT_REGISTER_FILE_START + cOutput) <= COS_VC4_OUTPUT_REGISTER_FILE_END);
                        ...
                        this->OutputRegister[Inst.m_Operands[0].m_Index[0].m_RegIndex][i].addr = COS_VC4_OUTPUT_REGISTER_FILE_START + cOutput++;
                        this->OutputRegister[Inst.m_Operands[0].m_Index[0].m_RegIndex][i].mux = COS_VC4_OUTPUT_REGISTER_FILE;
        ...
        case D3D10_SB_OPCODE_DCL_TEMPS:
            ...
            {
                VC4_ASSERT((COS_VC4_TEMP_REGISTER_FILE_START + cTemp) <= COS_VC4_TEMP_REGISTER_FILE_END);
                this->TempRegister[i / 4][i % 4].flags.valid = true;
                this->TempRegister[i / 4][i % 4].flags.temp = true;
                this->TempRegister[i / 4][i % 4].addr = COS_VC4_TEMP_REGISTER_FILE_START + cTemp++;
                this->TempRegister[i / 4][i % 4].mux = COS_VC4_TEMP_REGISTER_FILE;
