...
#include "CosUmdShader.tmh"

#include "CosUmdDevice.h"
#include "CosUmdShader.h"

void
CosUmdShader::Standup(
...
VC4_UNIFORM_FORMAT *
CosUmdShader::GetShaderUniformFormat(
...
CosUmdPipelineShader::Update()
{
    ...
    m_pCompiler = CosCompilerCreate(m_ProgramType,
                                    m_pCode,
                                    ...
                                    (const CosUmdRenderTargetView **)&m_pDevice->m_renderTargetViews[0],
                                    (const CosUmdShaderResourceView **)&m_pDevice->m_psResourceViews[0],
    ...
    throw CosUmdException(E_FAIL);
}

void
CosUmdPipelineShader::Teardown()
{
...
void
CosUmdTesselationShader::Standup(
...
void
CosUmdTesselationShader::Teardown()
{
    delete[] m_pInputSignatureEntries;
    delete[] m_pOutputSignatureEntries;
...
void
CosUmdTesselationShader::Update()
{
    //TODO:
}
